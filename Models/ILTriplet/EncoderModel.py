...
class EncoderModel:
    def __init__(self,
        ...
        # ===== Create model =====
        # ----- Create net -----
        self.net_name = 'Encoder net'
        self.layers   = OrderedDict()

        # ----- Stack 1 -----
        with tf.variable_scope('encoder_net', reuse = _reuse):
        ...
        # --- Params ---
        self.params = tf.get_collection(tf.GraphKeys.TRAINABLE_VARIABLES, scope = 'encoder_net')
    ...
    def clone(self,
              _state,
              _input):
        return EncoderModel(_state = _state,
                            _input = _input,
                            _reuse = True)
